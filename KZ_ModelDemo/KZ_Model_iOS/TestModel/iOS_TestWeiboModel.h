...
#import "iOS_TestWeiboUserModel.h"
#import "iOS_TestWeiboVisibleModel.h"
#import "iOS_TestWeiboImageInfoModel.h"

@interface iOS_TestWeiboModel : KZ_Model
...
@property (nonatomic, strong) iOS_TestWeiboUserModel *user;
...
@property (nonatomic, strong) iOS_TestWeiboVisibleModel *visible;
