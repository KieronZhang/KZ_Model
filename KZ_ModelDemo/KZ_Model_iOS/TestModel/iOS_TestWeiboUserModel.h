...
#import "iOS_TestWeiboBadgeModel.h"
#import "iOS_TestWeiboExtendModel.h"

@interface iOS_TestWeiboUserModel : KZ_Model
...
@property (nonatomic, strong) iOS_TestWeiboBadgeModel *badge;
@property (nonatomic, assign) int user_ability;
@property (nonatomic, strong) iOS_TestWeiboExtendModel *extend;
