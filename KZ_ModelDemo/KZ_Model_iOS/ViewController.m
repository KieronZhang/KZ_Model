...
#import "iOS_TestUser.h"
#import "iOS_User.h"
#import "iOS_TestModel.h"
#import "iOS_TestWeiboModel.h"
#import "KZ_iOS_TestModel.h"
...
//    iOS_TestUser *testUser = [[iOS_TestUser alloc] init];
//    return;
//
...
//
//    KZ_iOS_TestModel *model = [[KZ_iOS_TestModel alloc] initWithJSON:@{@"testPoint" : value, @"aClass" : NSClassFromString(@"NSString")}];
...
//    KZ_iOS_TestModel *copyModel = [model modelCopy];
...
//    return;
    ...
    NSArray *userArray = [KZ_ModelArray JSONWithClass:[iOS_User class] json:array];
    [itemsArray addObjectsFromArray:userArray];
    
    for (iOS_User *user in itemsArray) {
...
//
//    NSString *path = [[NSBundle mainBundle] pathForResource:@"iOS_TXT.txt" ofType:nil];
...
//        iOS_TestModel *testModel = [[iOS_TestModel alloc] initWithJSON:dict];
...
//    for (iOS_TestModel *testModel in array1) {
...
//        iOS_TestWeiboModel *weiboModel = [[iOS_TestWeiboModel alloc] initWithJSON:weiboDict];
...
//    for (iOS_TestWeiboModel *weiboModel in weiboArray1) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    iOS_User *user = itemsArray[indexPath.row];
