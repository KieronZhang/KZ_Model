...
#import "macOS_TestWeiboUserModel.h"
#import "macOS_TestWeiboVisibleModel.h"
#import "macOS_TestWeiboImageInfoModel.h"

@interface macOS_TestWeiboModel : KZ_Model
...
@property (nonatomic, strong) macOS_TestWeiboUserModel *user;
...
@property (nonatomic, strong) macOS_TestWeiboVisibleModel *visible;
