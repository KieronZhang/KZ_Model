...
#import "macOS_TestWeiboBadgeModel.h"
#import "macOS_TestWeiboExtendModel.h"

@interface macOS_TestWeiboUserModel : KZ_Model
...
@property (nonatomic, strong) macOS_TestWeiboBadgeModel *badge;
@property (nonatomic, assign) int user_ability;
@property (nonatomic, strong) macOS_TestWeiboExtendModel *extend;
